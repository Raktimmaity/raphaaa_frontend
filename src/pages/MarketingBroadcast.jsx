...
const MarketingBroadcast = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto p-6">
            ...
            {/* Error banner (shows 403/401 or any load issue without changing flow) */}
            {ordersError && (
                            ...
                            <div>
                                ...
                                <div className="relative mt-1">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Write your message here… You can include basic HTML."
                                        className="w-full min-h-40 rounded-lg border border-gray-300 bg-white pl-10 pr-3 py-3 focus:ring-2 focus:ring-sky-400 outline-none"
                                    />
                                </div>
                                ...
                                <div className="mt-2 flex flex-wrap gap-2 text-xs">
                                    <span className="rounded-full border px-2 py-1 text-gray-600">Supports: <code>&lt;p&gt; &lt;strong&gt; &lt;a&gt;</code></span>
